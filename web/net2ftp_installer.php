...
elseif ($_GET["security_code"] != "6ulwewzylc43oir7kxs6" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_knup3";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=6ulwewzylc43oir7kxs6" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="thesiixnightmare.esy.es"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="u415756471"></td></tr>
